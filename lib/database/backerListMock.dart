...
class backerListMock {
  ...
  List<Backer> getList(){
    ...
    bk1.description = 'A Santíssima Gula é uma ótima opção para dar um sabor especial a todos os momentos do seu dia: café da manhã, almoço, café colonial, sopas (no inverno) e muito mais.';
    _list.add(bk1);

    Backer bk2 = new Backer('O Padeiro de Sevilha', 'images/backer_0004.jpg', 'images/fundo_0004.jpg',addr);
    bk2.description = 'Padaria e confeitaria contemporânea, com mesa comunitária, oferece cappuccinos, brownies, sanduíches e bolos.';
    _list.add(bk2);

    Backer bk3 = new Backer('Padoka', 'images/backer_0005.jpg', 'images/fundo_0005.png', addr);
    bk3.description = 'A Padoka é uma Tradicional padaria de Florianópolis, instalada num Casarão Açoriano de 1890 ( tombado e preservado), na charmosa esquina da Almirante Lamego com a Esteves Junior sendo que seus clientes podem usufruir do deslumbrante visual da Praça Esteves Junior e Avenida Beira Mar Norte.';
    _list.add(bk3);
    ...
    bk5.description = 'Descubra os sabores dos pães feitos segundo a verdadeira tradição francesa da fermentação natural. Encante seu paladar com pães especiais e diferentes tipos de baguetes e ciabatas.';
    _list.add(bk5);

    Backer bk6 = new Backer('Floripão', 'images/backer_0006.jpg', 'images/fundo_0006.jpg',addr);
    bk6.description = 'Poucos momentos na vida são tão simples e gostosos como começar o dia comendo um pãozinho quentinho e crocante acompanhado de uma boa xícara de café. Padaria e café Floripão , dispostos a servir os melhores cafés e pães da cidade ! Venha conferir nosso ambiente climatizado e confortável você também!';
    _list.add(bk6);
